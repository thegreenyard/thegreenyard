...
<style>
  ...
  .gy-tour-card {
    padding-bottom: 38px;
    border-bottom: 1px solid rgba(23, 56, 44, 0.14);
  }
  ...
  .gy-tour-image {
    ...
    background: #17382c;
    box-shadow: 0 12px 30px rgba(18, 47, 36, 0.15);
  }
  ...
  <div class="gy-discover-grid">
    ...
    <div class="gy-tour-column">
      ...
      <article class="gy-tour-card">
        ...
        <p>
          Explore KC’s densely planted Florida food forest, where tropical fruit
          trees, edible plants, and unusual species grow together on just
          0.17 acres.
        </p>
