...
<section id="gy-tours-hero">
 ...
 <div class="gy-tours-slideshow" aria-hidden="true">
  ...
  <img
    src="../images/hero-01-grapes-trellis.jpg"
    class="gy-tours-slide is-active"
    alt=""
    fetchpriority="high">

  <img
    src="../images/hero-02-mature-canopy.jpg"
    class="gy-tours-slide"
    alt=""
    loading="eager">

  <img
    src="../images/hero-03-aerial-food-forest.jpg"
    class="gy-tours-slide"
    alt=""
    loading="lazy">

  <img
    src="../images/hero-04-bananas.jpg"
    class="gy-tours-slide"
    alt=""
    loading="lazy">

  <img
    src="../images/hero-05-food-forest-understory.jpg"
    class="gy-tours-slide"
    alt=""
    loading="lazy">

  <img
    src="../images/hero-06-young-food-forest.jpg"
    class="gy-tours-slide"
    alt=""
    loading="lazy">

  <img
    src="../images/hero-07-young-food-forest-aerial.jpg"
    class="gy-tours-slide"
    alt=""
    loading="lazy">

  <img
    src="../images/hero-08-young-food-forest-tour.jpg"
    class="gy-tours-slide"
    alt=""
    loading="lazy">

  <img
    src="../images/hero-09-loquat-tree.jpg"
    class="gy-tours-slide"
    alt=""
    loading="lazy">

  <img
    src="../images/hero-10-pineapple.jpg"
    class="gy-tours-slide"
    alt=""
    loading="lazy">

  <img
    src="../images/hero-11-starfruit-tree.jpg"
    class="gy-tours-slide"
    alt=""
    loading="lazy">

  <img
    src="../images/hero-12-nursery-overview.jpg"
    class="gy-tours-slide"
    alt=""
    loading="lazy">

  <img
    src="../images/hero-13-nursery-tour.jpg"
    class="gy-tours-slide"
    alt=""
    loading="lazy">
